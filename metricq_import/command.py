...
def command(name=""):
    def decorator(func):
        ...
        @click.option(
            "--import-password", default="admin", prompt=True, show_default=True
        )
        ...
        @click.option(
            "--check-interval/--no-check-interval",
            is_flag=True,
            default=True,
            show_default=True,
        )
        ...
        @click.option(
            ...
            is_flag=True,
            default=False,
            help="Suppress stdout from importer",
        )
        @click.option(
            "--ignore-out-of-range-timestamps",
            is_flag=True,
            default=False,
        ...
        def wrapper(
            ...
            **kwargs
            ...
            importer = DataheapToHTAImporter(
                metricq_token=metricq_token,
                metricq_url=metricq_url,
